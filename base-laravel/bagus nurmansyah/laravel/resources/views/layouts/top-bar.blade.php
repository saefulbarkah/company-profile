            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo d-none d-lg-block">
                        <!-- Brand -->
                        <a class="navbar-brand js-scroll-trigger" href="{{ asset('assets/index.html')}}">
                            <h2>Rapoo</h2>
                        </a>
                    </div>
                </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-primary main-nav navbar-togglable rounded-radius">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item ">
                            <a href="{{ asset('assets/about.html')}}" class="nav-link js-scroll-trigger">
                                About
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="{{ asset('assets/service.html')}}" class="nav-link js-scroll-trigger">
                                Services
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="{{ asset('assets/pricing.html')}}" class="nav-link js-scroll-trigger">
                                Pricing
                            </a>
                        </li>

                        <li class="nav-item ">
                            <a href="{{ asset('assets/project.html')}}" class="nav-link js-scroll-trigger">
                                Projects
                            </a>
                        </li>

                        <li class="nav-item ">
                            <a href="{{ asset('assets/contact.html')}}" class="nav-link">
                                Contact
                            </a>
                        </li>
                    </ul>
