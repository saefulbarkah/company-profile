        ...
        <section id="service" class="service">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <div class="mt-4">
                            <a href="{{ url('service/full-order') }}" class="btn btn-dark text-success">Selengkapnya</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
                    ...
                    <div class="icon-box">
                        ...
                        <div class="mt-4">
                            <a href="{{ url('service/makloon-sublime') }}" class="btn btn-dark text-success">Selengkapnya</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p class="pl-3"><br>Want to know more about this? <a href="#">Contact us</a></p>
                </div>
            </div>
        </div>
    </section>
