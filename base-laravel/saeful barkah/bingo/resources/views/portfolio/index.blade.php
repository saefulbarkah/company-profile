            ...
            <div class="col-lg-12">
                ...
                <div class="row filtr-container">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography, ios">
                        <div class="portfolio-block">
                            <img class="img-fluid" src=" {{ asset('_template/images/portfolio/portfolio-4.jpg') }}"
                                alt="">
                            <div class="caption">
                                <a class="search-icon"
                                    href=" {{ asset('_template/images/portfolio/portfolio-4.jpg') }}"
                                    data-lightbox="image-1">
                                    <i class="tf-ion-ios-search-strong"></i>
                                </a>
                                <h4><a href="">AirBnB Postcard</a></h4>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design">
                        <div class="portfolio-block">
                            <img class="img-fluid" src=" {{ asset('_template/images/portfolio/portfolio-5.jpg') }}"
                                alt="">
                            <div class="caption">
                                <a class="search-icon"
                                    href=" {{ asset('_template/images/portfolio/portfolio-5.jpg') }}"
                                    data-lightbox="image-1">
                                    <i class="tf-ion-ios-search-strong"></i>
                                </a>
                                <h4><a href="">AirBnB Postcard</a></h4>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, design, development">
                        <div class="portfolio-block">
                            <img class="img-fluid" src=" {{ asset('_template/images/portfolio/portfolio-6.jpg') }}"
                                alt="">
                            <div class="caption">
                                <a class="search-icon"
                                    href=" {{ asset('_template/images/portfolio/portfolio-6.jpg') }}"
                                    data-lightbox="image-1">
                                    <i class="tf-ion-ios-search-strong"></i>
                                </a>
                                <h4><a href="">AirBnB Postcard</a></h4>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 filtr-item " data-category="mix, photography">
                        <div class="portfolio-block">
                            <img class="img-fluid" src=" {{ asset('_template/images/portfolio/portfolio-7.jpg') }}"
                                alt="">
                            <div class="caption">
                                <a class="search-icon"
                                    href=" {{ asset('_template/images/portfolio/portfolio-7.jpg') }}"
                                    data-lightbox="image-1">
                                    <i class="tf-ion-ios-search-strong"></i>
                                </a>
                                <h4><a href="">AirBnB Postcard</a></h4>
