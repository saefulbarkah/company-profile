            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn btn-main"
                        href="<?php echo e(route('services')); ?>">Jelajahi kami</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                <img src="<?php echo e(asset('assets/images/about/member.jpg')); ?>" class="inline-block" alt="">
            </div>
            <div class="col-md-8">
...
<section class="about-2 section" id="about">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="<?php echo e(asset('assets/images/about/about-2.png')); ?>" class="img-fluid" alt="">
            </div>
            <div class="col-md-6">
                <ul class="checklist">
                ...
                <div class="testimonial-slider">
                    ...
                    <div class="item text-center">
                        ...
                        <div class="client-thumb">
                            <img src="<?php echo e(asset('assets/images/client-logo/clients-1.jpg')); ?>" class="img-fluid"
                                alt="">
                        </div>
                    ...
                    <div class="item text-center">
                        ...
                        <!-- client photo -->
                        <div class="client-thumb">
                            <img src="<?php echo e(asset('assets/images/client-logo/clients-2.jpg')); ?>" class="img-fluid"
                                alt="">
                        </div>
                        <div class="client-meta">
                            <h3>Emma Harrison</h3>
                    ...
                    <div class="item text-center">
                        ...
                        <!-- client photo -->
                        <div class="client-thumb">
                            <img src="<?php echo e(asset('assets/images/client-logo/clients-3.jpg')); ?>" class="img-fluid"
                                alt="">
                        </div>
                        <div class="client-meta">
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\File\templating-blade\base-laravel\saeful barkah\bingo\resources\views/home/index.blade.php ENDPATH**/ ?>