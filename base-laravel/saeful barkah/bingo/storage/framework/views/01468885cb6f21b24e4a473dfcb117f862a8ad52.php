<footer id="footer" class="bg-one">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3">
                    <ul>
                        ...
                        <li><a href="<?php echo e(route('services')); ?>">Layanan</a></li>
    ...
    <div class="footer-bottom">
        ...
        <h6>Desain Dan Dikembangkan Oleh <a href="">Saeful Barkah</a></h6>
    </div>
</footer>
<?php /**PATH D:\File\templating-blade\base-laravel\saeful barkah\bingo\resources\views/_layouts/footer.blade.php ENDPATH**/ ?>