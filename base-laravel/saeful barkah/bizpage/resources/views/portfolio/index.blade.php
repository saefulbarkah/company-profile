...
@section('subtitle-pages','Portfolio')
@section('content')
<!-- ======= Portfolio Section ======= -->
<section id="portfolio" class="section-bg">
    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-hijau">
            <div class="portfolio-wrap">
                <figure>
                    ...
                    <a href="{{ asset('assets/img/portfolio/baju-hijau-belakang.jpg') }}" data-lightbox="portfolio"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-hijau">
            <div class="portfolio-wrap">
                <figure>
                    <img src="{{ asset('assets/img/portfolio/baju-hijau-depan.jpg') }}" class="img-fluid" alt="">
